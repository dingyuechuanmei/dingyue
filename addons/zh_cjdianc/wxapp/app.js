...
App((_defineProperty(_App = {
    ...
    setNavigationBarColor: function(a) {
        var o = this.globalData.color;
        console.log(o, a), o && wx.setNavigationBarColor({
            frontColor: "#ffffff",
            backgroundColor: o
        }), a.setData({
            color: o
        ...
        o || e.util.request({
            ...
            success: function(o) {
                console.log(o), getApp().xtxx = o.data, e.globalData.color = o.data.color, e.setNavigationBarColor(a);
            }
        });
    },
