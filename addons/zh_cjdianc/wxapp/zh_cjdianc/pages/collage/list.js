...
Page({
    ...
    onLoad: function(t) {
        if (app.setNavigationBarColor(this), wx.setNavigationBarTitle({
            title: t.title
        }), console.log(t), null == t.id) var o = "";
        else o = t.id;
        if (null == t.store_id) var a = "";
        else a = t.store_id;
        if (null == t.store_logo) var e = "";
        else e = t.store_logo;
        if (null == t.display) var i = "";
        else i = t.display;
        this.setData({
            id: o,
            store_id: a,
    ...
    reload: function(t) {
        ...
        app.util.request({
            ...
            success: function(t) {
                console.log("商品列表", t), console.log(e), 0 < t.data.length && (wx.hideLoading(), e = e.concat(t.data), o.setData({
                    group_list: e,
                    page: a + 1
                }))
            }
