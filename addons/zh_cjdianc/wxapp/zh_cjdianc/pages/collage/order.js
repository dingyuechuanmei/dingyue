...
Page({
    ...
    reLoad: function() {
        ...
        app.util.request({
            ...
            success: function(t) {
                ...
                for (var e = 0; e < t.data.length; e++) t.data[e].xf_time = util.ormatDate(t.data[e].xf_time), t.data[e].pay_time = util.ormatDate(t.data[e].pay_time);
    ...
    orderPay: function(t) {
        ...
        console.log(e, a, o, n, r), "5" == r ? wx.showModal({
            title: "提示",
