...
Page({
    ...
    onLoad: function(t) {
        ...
        console.log(t), o.setData({
            ...
            success: function(e) {
                ...
                console.log(e, t.toString()), "" != e.data.dq_time && e.data.dq_time >= t.toString() && (e.data.ishy = 1), o.setData({
                    userInfo: e.data,
            ...
            success: function(e) {
                console.log(e), 1 == t.type ? (e.data.goods.yh = (Number(e.data.goods.y_price) - Number(e.data.goods.dd_price)).toFixed(2), e.data.goods.money = (1 * Number(e.data.goods.dd_price)).toFixed(2)) : (e.data.goods.yh = (Number(e.data.goods.y_price) - Number(e.data.goods.pt_price)).toFixed(2), e.data.goods.money = (1 * Number(e.data.goods.pt_price)).toFixed(2)), o.setData({
    ...
    alone_pay: function(e) {
        ...
        else if ("余额支付" == a.zfwz) c = 2;
        for (var u in n) if (n[u].id == o.type_id) var p = n[u].name;
        if (1 == a.options.type) var g = o.dd_price,
            f = 1,
            m = Number(f) * Number(g);
        else g = o.pt_price, f = 1, m = Number(f) * Number(g);
        var w = a.name,
            y = a.mobile,
            _ = a.store.address,
            h = a.note;
        console.log(o), console.log("用户id", i), console.log("商家id", s), Number(a.userInfo.wallet) < m && 2 == c ? (wx.hideLoading(), wx.showModal({
            title: "",
            content: "您的余额不足"
