...
Page({
    ...
    Coupons: function() {
        var o = this, t = wx.getStorageSync("users").id, e = o.data.store_id;
        app.util.request({
            ...
            success: function(t) {
                console.log(t.data);
                for (var e = [], a = 0; a < t.data.length; a++) "2" != t.data[a].type && e.push(t.data[a]);
                o.setData({
                    Coupons: e
                });
            }
    ...
    cartadd: function(t) {
        ...
        var c = 1;
        "0" == r.start_num || i.isInArray(s, n) || (c = Number(r.start_num)), console.log(c), 
        wx.showLoading({
            title: "正在加载",
            mask: !0
        }), app.util.request({
            ...
            success: function(t) {
                if (console.log(t), "1" == t.data) {
                    for (var e = 0; e < o.length; e++) for (var a = 0; a < o[e].good.length; a++) o[e].good[a].id == n && (o[e].good[a].quantity = c + o[e].good[a].quantity);
                    i.setData({
                        dishes: o
    ...
    subText: function() {
        ...
        if (console.log(e, a), e <= 0) t = "￥" + this.data.start_at + "元起送"; else if (e < a) {
            var o = a - e;
            ...
            success: function(d) {
                console.log(d.data), getApp().imgurl = d.data, c.setData({
                    ...
                    success: function(t) {
                        ...
                        console.log("当前的系统时间为" + g), console.log("商家的营业时间从" + e + "至" + a, o + "至" + s), 
                        1 == n ? (c.setData({
                            yysjtoggle: !1
                        }), console.log("商家正在休息" + n)) : console.log("商家正在营业" + n), e < s ? e < g && g < a || o < g && g < s ? (console.log("商家正常营业"), 
                        c.setData({
                            time: 1
                        })) : g < e || a < g && g < o ? (console.log("商家还没开店呐，稍等一会儿可以吗？"), c.setData({
                            time: 2,
                            yysjtoggle: !1
                        })) : s < g && (console.log("商家以及关店啦，明天再来吧"), c.setData({
                            time: 3,
                            yysjtoggle: !1
                        })) : s < e && (e < g && g < a || o < g && s < g || g < o && g < s ? (console.log("商家正常营业"), 
                        c.setData({
                            time: 1
                        })) : g < e || a < g && g < o ? (console.log("商家还没开店呐，稍等一会儿可以吗？"), c.setData({
                            time: 2,
