...
Page({
    ...
    Coupons: function() {
        ...
        app.util.request({
            ...
            success: function(t) {
                console.log(t.data);
                for (var a = 0; a < t.data.length; a++) t.data[a].sysl = parseInt((Number(t.data[a].number) - Number(t.data[a].stock)) / Number(t.data[a].number) * 100);
                e.setData({
                    Coupons: t.data
                });
            }
    ...
    refresh: function(t) {
        ...
        app.util.request({
            ...
            success: function(t) {
                ...
                "1" == a.is_qg && (e[4].active = !0, "" != a.qg_img && (e[4].img = a.qg_img), "" != a.qg_name && (e[4].name = a.qg_name), 
                "" != a.qgsm && (e[4].smwz = a.qgsm)), "1" == a.is_pt && (e[5].active = !0, "" != a.pt_img && (e[5].img = a.pt_img), 
                ...
                1 == r ? console.log("商家正在休息" + r) : console.log("商家正在营业" + r), s < n ? s < l && l < o || i < l && l < n ? (console.log("商家正常营业"), 
                d.setData({
                    time: 1
