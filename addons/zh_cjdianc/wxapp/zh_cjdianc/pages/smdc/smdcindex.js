...
Page({
    ...
    cartadd: function(t) {
        var a = t.currentTarget.dataset.itemIndex, e = t.currentTarget.dataset.parentindex, o = this.data.dishes, s = t.currentTarget.dataset.goodid, i = this, n = this.data.dishes[e].good[a], d = wx.getStorageSync("users").id, r = this.data.store_id;
    ...
    selectMenu: function(e) {
        var s = this.data.dishes, i = this, o = wx.getStorageSync("users").id, n = i.data.store_id, d = e.currentTarget.dataset.itemIndex;
        if (console.log(s, o, n, d), this.setData({
    ...
    onLoad: function(t) {
        ...
        var l = this, e = l.data.store_id, g = l.data.tableid;
        this.setData({
            params: {
                store_id: e,
                type: "全部",
        ...
        app.util.request({
            ...
            cachetime: "0",
            success: function(c) {
                console.log(c.data), getApp().imgurl = c.data, l.setData({
                    url: c.data
                }), app.util.request({
                    ...
                    success: function(t) {
                        ...
                        console.log("当前的系统时间为" + u), console.log("商家的营业时间从" + e + "至" + o, s + "至" + i), 
                        1 == n ? (l.setData({
                            yysjtoggle: !1
                        }), console.log("商家正在休息" + n)) : console.log("商家正在营业" + n), e < i ? e < u && u < o || s < u && u < i ? (console.log("商家正常营业"), 
                        l.setData({
                            time: 1
                        })) : u < e || o < u && u < s ? (console.log("商家还没开店呐，稍等一会儿可以吗？"), l.setData({
                            time: 2,
                            yysjtoggle: !1
                        })) : i < u && (console.log("商家以及关店啦，明天再来吧"), l.setData({
                            time: 3,
                            yysjtoggle: !1
                        })) : i < e && (e < u && u < o || s < u && i < u || u < s && u < i ? (console.log("商家正常营业"), 
                        l.setData({
                            time: 1
                        })) : u < e || o < u && u < s ? (console.log("商家还没开店呐，稍等一会儿可以吗？"), l.setData({
                            time: 2,
                        ...
                        for (var d = 0; d < t.data.store.environment.length; d++) t.data.store.environment[d] = c.data + t.data.store.environment[d];
                        for (var r = 0; r < t.data.store.yyzz.length; r++) t.data.store.yyzz[r] = c.data + t.data.store.yyzz[r];
            ...
            var s = wx.getStorageSync("users").id, n = l.data.store_id;
            console.log("uid", s), l.Coupons(), app.util.request({
                url: "entry/wxapp/Hot",
                cachetime: "0",
                data: {
                    store_id: n,
