...
class Core extends WeModuleSite
{
    ...
    public function getMainMenu()
    {
        ...
        $navemenu[19] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=rushtype&m=zh_cjdianc" class="panel-title wytitle" id="yframe-19"><icon style="color:#8d8d8d;" class="fa fa-life-ring"></icon>  限时抢购</a>',
                'items' => array(
                    0 => $this->createMainMenu('分类列表 ', $do, 'rushtype', ''),
                    1 => $this->createMainMenu('分类添加', $do, 'addrushtype', ''),
                    2 => $this->createMainMenu('商品管理', $do, 'qggoodall', '')
                )
            );
          $navemenu[18] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=grouptype&m=zh_cjdianc" class="panel-title wytitle" id="yframe-18"><icon style="color:#8d8d8d;" class="fa fa-life-ring"></icon>  拼团管理</a>',
                'items' => array(
        ...
        if($_W['isfounder'] || $_W['role'] == 'manager' || $_W['role'] == 'operator') {
            $navemenu[0] = array(
                ...
                'items' => array(
                   ...
                   // 4 => $this->createMainMenu('配送费 ', $do, 'psmoney', ''),
            ...
            // $navemenu[12] = array(
            //    'title' => '<a href="index.php?c=site&a=entry&op=display&do=number&m=zh_cjdianc" class="panel-title wytitle" id="yframe-12"><icon style="color:#8d8d8d;margin-right:15px;" class="fa fa-sellsy"></icon>  排队取号</a>',
            //     'items' => array(
        ...
        if($account['role']==1){
            $navemenu[0] = array(
                ...
                'items' => array(
                    ...
                    5 => $this->createSubMenu('预约设置', $do, 'dlyyset', 'fa-angle-right', $cur_color, $storeid),
                    ),
                'icon' => 'fa fa-user-md'
                );
            $cur_color = '#8d8d8d';
