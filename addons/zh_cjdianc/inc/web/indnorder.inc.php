...
// $wx = "select sum(money) as total from " . tablename("cjdc_order")." WHERE time LIKE ".$time."  and dn_state=2 and store_id=".$storeid." and is_yue=2 and type=2 and pay_time !=''";
// $wx = pdo_fetch($wx);//今天的微信店内销售额
// $yue = "select sum(money) as total from " . tablename("cjdc_order")." WHERE time LIKE ".$time."  and dn_state=2 and store_id=".$storeid." and is_yue=1 and type=2 and pay_time !=''";
// $yue = pdo_fetch($yue);//今天的余额店内销售额
// $jf = "select sum(money) as total from " . tablename("cjdc_order")." WHERE time LIKE ".$time."  and dn_state=2 and store_id=".$storeid." and is_yue=3 and type=2 and pay_time !=''";
// $jf = pdo_fetch($jf);//今天的积分店内销售额

// $ztwx = "select sum(money) as total from " . tablename("cjdc_order")." WHERE time LIKE ".$time2."  and dn_state=2 and store_id=".$storeid." and is_yue=2 and type=2 and pay_time !=''";
// $ztwx = pdo_fetch($ztwx);//昨天的微信店内销售额
// $ztyue = "select sum(money) as total from " . tablename("cjdc_order")." WHERE time LIKE ".$time2."  and dn_state=2 and store_id=".$storeid." and is_yue=1 and type=2 and pay_time !=''";
// $ztyue = pdo_fetch($ztyue);//昨天的余额店内销售额
// $ztjf = "select sum(money) as total from " . tablename("cjdc_order")." WHERE time LIKE ".$time2."  and dn_state=2 and store_id=".$storeid." and is_yue=3 and type=2 and pay_time !=''";
...
// $dn2 = "select * from " . tablename("cjdc_order")." WHERE time LIKE ".$time."   and type=2 and dn_state=2 and store_id=".$storeid." and uniacid=".$_W['uniacid'];
// $dn2 = count(pdo_fetchall($dn2));//今天店内订单量
// $wxdn2 = "select * from " . tablename("cjdc_order")." WHERE time LIKE ".$time."   and type=2 and dn_state=2 and store_id=".$storeid." and is_yue=2 and uniacid=".$_W['uniacid'];
// $wxdn2 = count(pdo_fetchall($wxdn2));//今天店内微信订单量
// $yuedn2 = "select * from " . tablename("cjdc_order")." WHERE time LIKE ".$time."   and type=2 and dn_state=2 and store_id=".$storeid." and is_yue=1 and uniacid=".$_W['uniacid'];
// $yuedn2 = count(pdo_fetchall($yuedn2));//今天店内余额订单量
// $jfdn2 = "select * from " . tablename("cjdc_order")." WHERE time LIKE ".$time."   and type=2 and dn_state=2 and store_id=".$storeid." and is_yue=3 and uniacid=".$_W['uniacid'];
// $jfdn2 = count(pdo_fetchall($jfdn2));//今天店内积分订单量




// $ztdn2 = "select * from " . tablename("cjdc_order")." WHERE time LIKE ".$time2."   and type=2 and dn_state=2 and store_id=".$storeid." and uniacid=".$_W['uniacid'];
// $ztdn2 = count(pdo_fetchall($ztdn2));//昨天店内订单量
// $ztwxdn2 = "select * from " . tablename("cjdc_order")." WHERE time LIKE ".$time2."   and type=2 and dn_state=2 and store_id=".$storeid." and is_yue=2 and uniacid=".$_W['uniacid'];
// $ztwxdn2 = count(pdo_fetchall($ztwxdn2));//昨天店内微信订单量
// $ztyuedn2 = "select * from " . tablename("cjdc_order")." WHERE time LIKE ".$time2."   and type=2 and dn_state=2 and store_id=".$storeid." and is_yue=1 and uniacid=".$_W['uniacid'];
// $ztyuedn2 = count(pdo_fetchall($ztyuedn2));//昨天店内余额订单量
// $ztjfdn2 = "select * from " . tablename("cjdc_order")." WHERE time LIKE ".$time2."   and type=2 and dn_state=2 and store_id=".$storeid." and is_yue=3 and uniacid=".$_W['uniacid'];
...
// $res=pdo_get('cjdc_order',array('id'=>$_GPC['id']));
// $res3=pdo_get('cjdc_dyj',array('uniacid'=>$_W['uniacid'],'store_id'=>$res['store_id'],'state'=>1,'location'=>1));
// $res2=pdo_getall('cjdc_goods',array('order_id'=>$_GPC['id']));
...
// message('打印成功！', $this->createWebUrl('indnorder'), 'success');
//   return $result;
// }
// if($res3['type']==2){//易联云
...
//     $time=date("Y-m-d");
//     $time="'%$time%'";
//         $count = pdo_fetchcolumn("SELECT COUNT(*) FROM". tablename("cjdc_order")." WHERE time LIKE ".$time."and type=2 and store_id =".$storeid);
...
//             $sql = "select a.*,b.md_name,c.name as table_name from " . tablename("cjdc_order")."  a"  . " left join " . tablename("cjdc_store")." b on a.store_id=b.id " . " left join " . tablename("cjdc_table") . " c on c.id=a.table_id  WHERE a.time LIKE ".$time." and a.type=2 and a.store_id =".$storeid." limit " . ($j - 1) * 5000 . ",5000 ";
...
//                             $row['dn_state']='已评论';
//                         }
//                         $good=pdo_getall('cjdc_goods',array('order_id'=>$row['id']));
//                         $date6='';
