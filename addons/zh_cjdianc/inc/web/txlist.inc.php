...
if($type!='all'){   
 $where.= " and a.state=$state"; 
  ...
  $sql="SELECT a.*,b.name,b.user_id,c.name as sk_name FROM ".tablename('cjdc_withdrawal') .  " a"  . " left join " . tablename("cjdc_store") . " b on a.store_id=b.id left join " . tablename("cjdc_user") . " c on c.id=b.user_id ". $where." ORDER BY a.time DESC";
